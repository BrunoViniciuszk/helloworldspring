...
public class DaoProduto {
	...
	public void inserir(Produto produto) {
		String sql = "insert into tb_produto(nome, data_validade, preco, estoque, tipo_produto)" 
					+ "values(?,?,?,?,?)";
	...
	public List<Produto> listar() {
		...
		try {
			...
			while (rs.next()) {
				...
				// extrai a posiçao da enumeração do resultset
				int posEnum = rs.getInt("tipo_produto");
				// Descobre a enumeraco através da posicao
